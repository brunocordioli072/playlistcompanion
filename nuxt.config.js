...
export default {
    ...
    link: [
      {
        rel: 'icon',
        type: 'image/x-icon',
        href: '/companion-explorer/logo.ico',
      },
    ],
  },
  /*
  ...
  env: {
    WORKER_URL: process.env.WORKER_URL ?
      ...
      'https://rqt6sty8u4.execute-api.us-east-1.amazonaws.com/prod',
    BRIDGE_URL: process.env.BRIDGE_URL ?
      process.env.BRIDGE_URL :
      'https://5v3pwv399f.execute-api.us-east-1.amazonaws.com/prod/graphql',
  },
  /*
   ** Nuxt.js modules
   */
